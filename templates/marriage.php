...
<table class="table">
    <?php if ($proposal_sent) : ?>
        <tr>
            <th>Proposal to <?= $proposal_user['user_name'] ?></th>
        </tr>
        <tr>
    ...
    <?php elseif ($player->spouse <= 0) : ?>
        <?php if ($player->spouse < 0) : ?>
            ...
            <?php else : ?>
                <tr>
                    <th><?= $proposal_user['user_name'] ?>'s Proposal</th>
                </tr>
                <tr>
                    <td style="text-align: center;">
    ...
    <table class='table'>
        <tr>
            <th>Your Family Tree</th>
        </tr>
        <tr>
            <td id='family_tree'>
                <canvas id='family_tree_canvas' height='800' width="700">
                </canvas>
            </td>
        </tr>
    </table>
